                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>{{trans('file.Lowest Price')}}</strong> </label>
                                        <input type="number" name="lowest_price" value="{{$lims_product_data->lowest_price}}" class="form-control" step="any" placeholder="{{trans('file.Optional minimum selling price')}}">
                                        <small class="text-muted">{{trans('file.Set minimum price to prevent selling below this amount')}}</small>
                                    </div>
                                    <div class="form-group">
