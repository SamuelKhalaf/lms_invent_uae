...
<script type="text/javascript">
    ...
    // Auto-refresh table when page loads with success message
    $(document).ready(function() {
        // Check if there's a success message and refresh the table
        if ($('.alert-success').length > 0) {
            // Small delay to ensure the message is visible before refreshing
            setTimeout(function() {
                returnTable.ajax.reload(null, false); // false = stay on current page
            }, 500);
        }
    });
    ...
    function returnDetails(returns){
        ...
        var htmltext = '<strong>{{trans("file.Date")}}: </strong>'+returns[0]+'<br><strong>{{trans("file.reference")}}: </strong>'+returns[1]+'<br><strong>{{trans("file.Sale Reference")}}: </strong>'+returns[24]+'<br><strong>{{trans("file.Warehouse")}}: </strong>'+returns[2]+'<br><br><div class="row"><div class="col-md-6"><strong>{{trans("file.From")}}:</strong><br>'+returns[3]+'<br>'+returns[4]+'<br>'+returns[5]+'<br>'+returns[6]+'<br>'+returns[7]+'<br>'+returns[8]+'</div><div class="col-md-6"><div class="float-right"><strong>{{trans("file.To")}}:</strong><br>'+returns[9]+'<br>'+returns[10]+'<br>'+returns[11]+'<br>'+returns[12]+'</div></div></div>';
