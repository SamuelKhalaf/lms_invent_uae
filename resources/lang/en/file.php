...
return [
	...
	"All Due Reports" => "All Due Reports",
    "Customer" => "Customer",
    "All Customers" => "All Customers",
    "Lowest Price" => "Lowest Price",
    "Optional minimum selling price" => "minimum selling price",
    "Set minimum price to prevent selling below this amount" => "minimum price to prevent selling below this amount",
    "Price below minimum not allowed" => "Price below minimum not allowed",
    "The selling price cannot be lower than the minimum price set for this product" => "The selling price cannot be lower than the minimum price set for this product",
